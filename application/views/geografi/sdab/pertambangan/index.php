<div class="section">
	...
	<div class="page-header">
		...
		<li class="breadcrumb-item"><a href="#"><i class="ti-package mr-1"></i>Geografi</a></li>
			<li class="breadcrumb-item active" aria-current="page">SDAB</li>
			<li class="breadcrumb-item active" aria-current="page">Pertambangan</li>
		</ol>
	</div>
	<!-- Page-header closed -->
		...
		<div class="col-md-12 col-lg-12">
			<div class="card" style="overflow:auto;">
				<div class="card-header">
					<div class="card-title">Pertambangan</div>
				...
				<div class="card-body">
					...
					<table id="example" style="table-layout: auto; width: 100%;" class="table table-striped  table-bordered key-buttons text-nowrap lowercaseCaption_DT">
							...
							<tbody>
								<?php $no=1; foreach($dataPertambangan as $pertambangan): ?>
								<tr>
									<td class="text-center">
										<?php if(policy('GEO','update')): ?>
										<button onclick="editModal(`<?= encrypt($pertambangan->id_pertambangan); ?>`)"
										...
										<button
											onclick="deleteConfirm(`<?= encrypt($pertambangan->id_pertambangan); ?>`,'Pertambangan')"
									...
									<td><?= $no++ ?></td>
									<td><?= $pertambangan->nama_satker ?></td>
									<td><?= $pertambangan->wilayah ?></td>
									<td><?= $pertambangan->jenis_bahantambang ?></td>
									<td><?= $pertambangan->teknik_penambangan ?></td>
									<td><?= $pertambangan->penggunaan ?></td>
									<td><?= $pertambangan->jumlah_tenaga_kerja ?></td>
									<td><?= $pertambangan->luas_tambang ?></td>
									<td><?= $pertambangan->tonase_hasil ?></td>
									<td><?= $pertambangan->pemilik ?></td>
									<td><?= $pertambangan->keterangan ?></td>
									<td><?= $pertambangan->nama_pegawai ?></td>
									<td><?= $pertambangan->LastUpdated ?></td>
								</tr>
								<?php endforeach ?>
							</tbody>
						</table>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<!-- <div class="form-group row">
								<label class="col-md-3 col-form-label" for="type">Jenis Bahan Tambang</label>
								<div class="col-md-9">
									<input type="text" id="" name="type" class="form-control">
									<div class="invalid-feedback warning-type"></div>
								</div>
							</div> -->
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="material">Jenis Bahan Tambang</label>
								<div class="col-md-9">
									<select class="form-control" name="type" id="type" style="width: 100%;">
										<?php foreach($jenisBahanTambang as $jenis): ?>
											<option value="<?= $jenis->id_jenis_bahantambang ?>"><?= $jenis->nama ?></option>
										<?php endforeach?>
									</select>
									<div class="invalid-feedback warning-type"></div>
								</div>
							...
							<!-- <div class="form-group row">
								<label class="col-md-3 col-form-label" for="technique">Teknik Penambangan</label>
								<div class="col-md-9">
									<input type="text" id="" name="technique" class="form-control">
									<div class="invalid-feedback warning-technique"></div>
								</div>
							</div> -->
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="technique">Teknik Penambangan</label>
								<div class="col-md-9">
									<select class="form-control" name="technique" id="technique" style="width: 100%;">
							...
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="use">Penggunaan</label>
								<div class="col-md-9">
									<input type="text" id="" name="use" class="form-control">
									<div class="invalid-feedback warning-use"></div>
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="employees">Jumlah Tenaga Kerja</label>
								<div class="col-md-9">
									<input type="number" id="" name="employees" class="form-control">
									<div class="invalid-feedback warning-employees"></div>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="area">Luas Tambang (Ha)</label>
								<div class="col-md-9">
									<input type="text" onkeypress="return isNumberKey(event)" id="" name="area" class="form-control">
									<div class="invalid-feedback warning-area"></div>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="tonase">Tonase Hasil (Ton)</label>
								<div class="col-md-9">
									<input type="text" onkeypress="return isNumberKey(event)" id="" name="tonase" class="form-control">
									<div class="invalid-feedback warning-tonase"></div>
								</div>
							</div>
							<div class="form-group row">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="material">Jenis Bahan Tambang</label>
								<div class="col-md-9">
									<select class="form-control" name="type" id="typeEdit" style="width: 100%;">
										<?php foreach($jenisBahanTambang as $jenis): ?>
											<option value="<?= $jenis->id_jenis_bahantambang ?>"><?= $jenis->nama ?></option>
										<?php endforeach?>
									</select>
							...
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="technique">Teknik Penambangan</label>
								<div class="col-md-9">
									<select class="form-control" name="technique" id="techniqueEdit" style="width: 100%;">
...
<script>
	$(document).ready(function () {
		...
		$('#addForm').submit(function () {
			$.ajax({
				type: "POST",
				url: "<?= site_url() ?>/geografi_pertambangan/store",
				dataType: "json",
				data: $(this).serialize(),
		...
		$('#editForm').submit(function () {
			$.ajax({
				type: "POST",
				url: "<?= site_url() ?>geografi_pertambangans/update",
				dataType: "json",
				data: $(this).serialize(),
				success: function (data) {
					if (data[0].status == 0) {
	...
	function editModal(id) {
		...
		$.ajax({
			type: 'ajax',
			method: 'GET',
			url: '<?= site_url() ?>geografi_pertambangan/' + id,
			data: {
				id: id
			},
			dataType: 'json',
			success: function (data) {
				...
				$('select[name=technique]').find('option:selected').removeAttr('selected');
				$('input[name="id"]').val(id);
				$('input[name="satker"]').val(data.pertambangan.id_satker);
				$('input[name="use"]').val(data.pertambangan.penggunaan);
				$('input[name="owner"]').val(data.pertambangan.pemilik);
				$('input[name="employees"]').val(data.pertambangan.jumlah_tenaga_kerja);
				$('input[name="area"]').val(data.pertambangan.luas_tambang);
				$('input[name="tonase"]').val(data.pertambangan.tonase_hasil);
				$('input[name="notes"]').val(data.pertambangan.keterangan);
				$('input[name="flag_locationedit"]').val(data.pertambangan.flag_location);
				//$("select[name=satker] option[value="+data.pertambangan.id_satker+"]").attr('selected','selected');
				$("select[name=satkerPicked] option[value=" + data.pertambangan.id_satker + "]").attr('selected','selected');
				//$("select[name=provinsi] option[value="+data.pertambangan.id_provinsi+"]").attr('selected','selected');
				//$("select[name=type] option[value="+data.pertambangan.id_jenis_bahantambang+"]").attr('selected','selected');
				//$("select[name=technique] option[value="+data.pertambangan.teknik_penambangan+"]").attr('selected','selected');

				$("#satkerEdit").val(data.pertambangan.id_satker);
				$("#provinsiEdit").val(data.pertambangan.id_provinsi);
				$("#typeEdit").val(data.pertambangan.id_jenis_bahantambang);
				$("#techniqueEdit").val(data.pertambangan.teknik_penambangan);
				...
				$("#techniqueEdit").trigger('change');

				// getProvinsi(data.pertambangan.id_provinsi)
				// getKabupaten(data.pertambangan.id_provinsi,data.pertambangan.id_kabupaten)
				// getKecamatan(data.pertambangan.id_kabupaten,data.pertambangan.id_kecamatan)
				// getKelurahan(data.pertambangan.id_kecamatan,data.pertambangan.id_kelurahan)

				if(data.pertambangan.flag_location == 'prov')
				{
					getProvinsi(data.pertambangan.id_provinsi)
					getKabupaten(data.pertambangan.id_provinsi,0)
					getKecamatan(0,0)
					getKelurahan(0,0)
				}
				else if(data.pertambangan.flag_location == 'kab')
				{
					getProvinsi(data.pertambangan.id_provinsi)
					getKabupaten(data.pertambangan.id_provinsi,data.pertambangan.id_kabupaten)
					getKecamatan(data.pertambangan.id_kabupaten,0)
					getKelurahan(0,0)
				}
				else if(data.pertambangan.flag_location == 'kec')
				{
					getProvinsi(data.pertambangan.id_provinsi)
					getKabupaten(data.pertambangan.id_provinsi,data.pertambangan.id_kabupaten)
					getKecamatan(data.pertambangan.id_kabupaten,data.pertambangan.id_kecamatan)
					getKelurahan(data.pertambangan.id_kecamatan,0)
				}
				else if(data.pertambangan.flag_location == 'kel')
				{
					getProvinsi(data.pertambangan.id_provinsi)
					getKabupaten(data.pertambangan.id_provinsi,data.pertambangan.id_kabupaten)
					getKecamatan(data.pertambangan.id_kabupaten,data.pertambangan.id_kecamatan)
	...
	function deleteConfirm(id, content) {
		...
		$('#formDelete').attr('action', '<?= site_url() ?>geografi_pertambangan/' + id + '/delete');
		$('#deleteModal').modal();
	}
</script>
