		...
		<div class="col-md-12 col-lg-12">
			<div class="card" style="overflow:auto;">
				<div class="card-header">
					<div class="card-title">Pembudidayaan Ikan</div>
							...
							<tbody>
								...
								<tr>
									<td class="text-center">
										...
										<button onclick="editModal(`<?= encrypt($ikan->id_budidaya_ikan); ?>`)"
										...
										<button
											onclick="deleteConfirm(`<?= encrypt($ikan->id_budidaya_ikan); ?>`,'Budidaya Ikan')"
									...
									<td><?= $ikan->luas ?></td>
									<td><?= $ikan->tonase_hasil ?></td>
									<td><?= $ikan->masa_panen ?></td>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="area">Luas Tambak (Ha)</label>
								<div class="col-md-9">
...
<script>
	$(document).ready(function () {
		...
		$('#addForm').submit(function () {
			$.ajax({
				type: "POST",
				url: "<?= site_url() ?>/geografi_budidayaIkan/store",
				dataType: "json",
				data: $(this).serialize(),
		...
		$('#editForm').submit(function () {
			$.ajax({
				type: "POST",
				url: "<?= site_url() ?>geografi_budidayaIkans/update",
				dataType: "json",
				data: $(this).serialize(),
				success: function (data) {
					if (data[0].status == 0) {
	...
	function editModal(id) {
		...
		$.ajax({
			type: 'ajax',
			method: 'GET',
			url: '<?= site_url() ?>geografi_budidayaIkan/' + id,
			data: {
				id: id
			},
			dataType: 'json',
			success: function (data) {
				...
				$('input[name="area"]').val(data.ikan.luas);
				$('input[name="result"]').val(data.ikan.tonase_hasil);
				$('input[name="period"]').val(data.ikan.masa_panen);
				...
				//$("select[name=type] option[value="+data.ikan.id_jenis_ikan+"]").attr('selected','selected');
	...
	function deleteConfirm(id, content) {
		...
		$('#formDelete').attr('action', '<?= site_url() ?>geografi_budidayaIkan/' + id + '/delete');
		$('#deleteModal').modal();
	}
</script>
