			...
			<div class="card" style="overflow:auto;">
				...
				<div class="card-body">
					...
					<table id="example" style="table-layout: auto; width: 100%;" class="table table-striped  table-bordered key-buttons text-nowrap lowercaseCaption_DT">
							...
							<tbody>
								<?php $no=1; foreach($dataPenduduk as $penduduk): ?>
								<tr>
									<td class="text-center">
										<?php if(policy('DEMO','update')): ?>
										<button onclick="editModal(`<?= encrypt($penduduk->id_jumlah_penduduk); ?>`)"
										...
										<button
											onclick="deleteConfirm(`<?= encrypt($penduduk->id_jumlah_penduduk); ?>`,'Jumlah Penduduk')"
									...
									<td><?= $no++ ?></td>
									<td><?= $penduduk->nama_satker ?></td>
									<td><?= $penduduk->wilayah ?></td>
									<td><?= $penduduk->jumlah_penduduk ?></td>
									<td><?= $penduduk->jumlah_pria ?></td>
									<td><?= $penduduk->jumlah_wanita ?></td>
									<td><?= $penduduk->age0018 ?></td>
									<td><?= $penduduk->age1839 ?></td>
									<td><?= $penduduk->age4045 ?></td>
									<td><?= $penduduk->age55high ?></td>
									<td><?= $penduduk->tahun ?></td>
									<td><?= $penduduk->angka_kelahiran ?></td>
									<td><?= $penduduk->angka_kematian ?></td>
									<td><?= $penduduk->SMP ?></td>
									<td><?= $penduduk->SMA ?></td>
									<td><?= $penduduk->S1 ?></td>
									<td><?= $penduduk->S2 ?></td>
									<td><?= $penduduk->keterangan ?></td>
									<td><?= $penduduk->nama_pegawai ?></td>
									<td><?= $penduduk->LastUpdated ?></td>
								</tr>
								<?php endforeach ?>
							</tbody>
						</table>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="jumlah_pria">Jumlah Pria</label>
								<div class="col-md-9">
									<input type="number" id="" name="jumlah_pria" class="form-control">
									<div class="invalid-feedback warning-jumlah_pria"></div>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="jumlah_wanita">Jumlah Wanita</label>
								<div class="col-md-9">
									<input type="number" id="" name="jumlah_wanita" class="form-control">
									<div class="invalid-feedback warning-jumlah_wanita"></div>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="age0018">Usia 0-18 (Tahun)</label>
								<div class="col-md-9">
									<input type="number" id="" name="age0018" class="form-control">
									<div class="invalid-feedback warning-age0018"></div>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="age1839">Usia 18-40 (Tahun)</label>
								<div class="col-md-9">
									<input type="number" id="" name="age1839" class="form-control">
									<div class="invalid-feedback warning-age1839"></div>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="age4045">Usia 40-45 (Tahun)</label>
								<div class="col-md-9">
									<input type="number" id="" name="age4045" class="form-control">
									<div class="invalid-feedback warning-age4045"></div>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="age55high">Usia >55 (Tahun)</label>
								<div class="col-md-9">
									<input type="number" id="" name="age55high" class="form-control">
									<div class="invalid-feedback warning-age55high"></div>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="tahun">Tahun</label>
								<div class="col-md-9">
									<input type="number" id="" name="tahun" class="form-control">
									<div class="invalid-feedback warning-tahun"></div>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="angka_kelahiran">Angka Kelahiran</label>
								<div class="col-md-9">
									<input type="number" id="" name="angka_kelahiran" class="form-control">
									<div class="invalid-feedback warning-angka_kelahiran"></div>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="angka_kematian">Angka Kematian</label>
								<div class="col-md-9">
									<input type="number" id="" name="angka_kematian" class="form-control">
									<div class="invalid-feedback warning-angka_kematian"></div>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="SMP">SMP</label>
								<div class="col-md-9">
									<input type="number" id="" name="SMP" class="form-control">
									<div class="invalid-feedback warning-SMP"></div>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="SMA">SMA</label>
								<div class="col-md-9">
									<input type="number" id="" name="SMA" class="form-control">
									<div class="invalid-feedback warning-SMA"></div>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="S1">S1</label>
								<div class="col-md-9">
									<input type="number" id="" name="S1" class="form-control">
									<div class="invalid-feedback warning-S1"></div>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-md-3 col-form-label" for="S2">S2</label>
								<div class="col-md-9">
									<input type="number" id="" name="S2" class="form-control">
									<div class="invalid-feedback warning-S2"></div>
								</div>
							</div>
							<div class="form-group row">
...
<script>
	$(document).ready(function () {
		...
		$('#addForm').submit(function () {
			$.ajax({
				type: "POST",
				url: "<?= site_url() ?>/demografi_jumlahPenduduk/store",
				dataType: "json",
				data: $(this).serialize(),
		...
		$('#editForm').submit(function () {
			$.ajax({
				type: "POST",
				url: "<?= site_url() ?>demografi_jumlahPenduduks/update",
				dataType: "json",
				data: $(this).serialize(),
				success: function (data) {
					if (data[0].status == 0) {
	...
	function editModal(id) {
		...
		$.ajax({
			type: 'ajax',
			method: 'GET',
			url: '<?= site_url() ?>demografi_jumlahPenduduk/' + id,
			data: {
				id: id
			},
			dataType: 'json',
			success: function (data) {
				...
				$('input[name="satker"]').val(data.penduduk.id_satker);
				$('input[name="jumlah_penduduk"]').val(data.penduduk.jumlah_penduduk);
				$('input[name="jumlah_pria"]').val(data.penduduk.jumlah_pria);
				$('input[name="jumlah_wanita"]').val(data.penduduk.jumlah_wanita);
				$('input[name="age0018"]').val(data.penduduk.age0018);
				$('input[name="age1839"]').val(data.penduduk.age1839);
				$('input[name="age4045"]').val(data.penduduk.age4045);
				$('input[name="age55high"]').val(data.penduduk.age55high);
				$('input[name="tahun"]').val(data.penduduk.tahun);
				$('input[name="angka_kelahiran"]').val(data.penduduk.angka_kelahiran);
				$('input[name="angka_kematian"]').val(data.penduduk.angka_kematian);
				$('input[name="SMP"]').val(data.penduduk.SMP);
				$('input[name="SMA"]').val(data.penduduk.SMA);
				$('input[name="S1"]').val(data.penduduk.S1);
				$('input[name="S2"]').val(data.penduduk.S2);
				$('input[name="notes"]').val(data.penduduk.keterangan);
				$('input[name="flag_locationedit"]').val(data.penduduk.flag_location);
				//$("select[name=satker] option[value=" + data.penduduk.id_satker + "]").attr('selected','selected');
				$("select[name=satkerPicked] option[value=" + data.penduduk.id_satker + "]").attr('selected','selected');
				//$("select[name=provinsi] option[value=" + data.penduduk.id_provinsi + "]").attr('selected','selected');
				$("select[name=religion] option[value=" + data.penduduk.id_jenis_agama + "]").attr('selected','selected');

				$("#satkerEdit").val(data.penduduk.id_satker);
				$("#provinsiEdit").val(data.penduduk.id_provinsi);
				...
				// getProvinsi(data.penduduk.id_provinsi)
				// getKabupaten(data.penduduk.id_provinsi, data.penduduk.id_kabupaten)
				// getKecamatan(data.penduduk.id_kabupaten, data.penduduk.id_kecamatan)
				// getKelurahan(data.penduduk.id_kecamatan, data.penduduk.id_kelurahan)

				if(data.penduduk.flag_location == 'prov')
				{
					getProvinsi(data.penduduk.id_provinsi)
					getKabupaten(data.penduduk.id_provinsi,0)
					getKecamatan(0,0)
					getKelurahan(0,0)
				}
				else if(data.penduduk.flag_location == 'kab')
				{
					getProvinsi(data.penduduk.id_provinsi)
					getKabupaten(data.penduduk.id_provinsi,data.penduduk.id_kabupaten)
					getKecamatan(data.penduduk.id_kabupaten,0)
					getKelurahan(0,0)
				}
				else if(data.penduduk.flag_location == 'kec')
				{
					getProvinsi(data.penduduk.id_provinsi)
					getKabupaten(data.penduduk.id_provinsi,data.penduduk.id_kabupaten)
					getKecamatan(data.penduduk.id_kabupaten,data.penduduk.id_kecamatan)
					getKelurahan(data.penduduk.id_kecamatan,0)
				}
				else if(data.penduduk.flag_location == 'kel')
				{
					getProvinsi(data.penduduk.id_provinsi)
					getKabupaten(data.penduduk.id_provinsi,data.penduduk.id_kabupaten)
					getKecamatan(data.penduduk.id_kabupaten,data.penduduk.id_kecamatan)
	...
	function deleteConfirm(id, content) {
		...
		$('#formDelete').attr('action', '<?= site_url() ?>demografi_jumlahPenduduk/' + id + '/delete');
		$('#deleteModal').modal();
	}
