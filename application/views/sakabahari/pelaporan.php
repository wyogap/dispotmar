	...
	<div class="modal-dialog" role="document" style="margin-right:600px;">
		<div class="modal-content" style="width:1100px;">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Aktivitas Saka Bahari Per Satker</h5>
...
<div class="modal fade" id="detildataPersonel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	...
	<div class="modal-dialog" role="document" style="margin-right:600px;">
		<div class="modal-content" style="width:1100px;">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Aktifitas Saka Bahari per Personal</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">×</span>
				</button>
			</div>
...
<script type="text/javascript">
	...
	function getMainActitivies(){
		$.ajax({
			url   : "<?= site_url()?>api/getSakaActivity/<?= $this->uri->segment($this->uri->total_segments()) ?>",
			type  : 'GET',
			async : true,
			dataType : 'json',
	...
	function detildataSatker(value1) {
		$.ajax({
			type: "GET",
			url : "<?= site_url() ?>api/getSakaActivityBySatker/" + value1,
			dataType : 'json',
	...
	function detildataPersonel(value1) {
		$.ajax({
			type: "GET",
			url : "<?= site_url() ?>api/getSakaActivityByPersonel/" + value1,
			dataType : 'json',
			success: function (datas) {
				//console.log(datas)
			var counter = 1
