...
class BudayaController extends CI_Controller {
	...
	{
		$this->data['title'] = 'Kondsos - Budaya';

		if (policy('KONSOS','read')) {
			$this->data['dataBudaya'] = $this->budaya->getdataForDatatable(['satker' => $this->session->userdata('id_satker')]);
		}else if (policy('KONSOS','read_all')){
			$this->data['dataBudaya'] = $this->budaya->getdataForDatatable();
		}

		$this->data['satkers'] = $this->satker->get();
		$this->data['provinsi'] = $this->geo->getLevel(1);

		$data['isi'] = $this->load->view('kondsos/budaya/index', $this->data, true);
	...
	public function show($id)
	{
		...
		$this->data['budaya'] = $this->budaya->find(decrypt($id));
	...
	public function store(){
		...
		$this->form_validation->set_rules('kebudayaan', 'Kebudayaan Asli', 'trim|required');
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$response = [
				...
				'kebudayaan'			=> form_error('kebudayaan'),
			...
			$data = array(
				...
				'kebudayaan_asli'		=> $this->input->post('kebudayaan'),
	...
	public function delete($id=null)
    {
		...
		if ($this->budaya->delete(decrypt($id))) {
