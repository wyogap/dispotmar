...
class PartaiPolitikController extends CI_Controller {
	...
	{
		$this->data['title'] = 'Kondsos - Partai Politik';

		if (policy('KONSOS','read')) {
			$this->data['dataParpol'] = $this->parpol->getdataForDatatable(['satker' => $this->session->userdata('id_satker')]);
		}else if (policy('KONSOS','read_all')){
			$this->data['dataParpol'] = $this->parpol->getdataForDatatable();
		}
		...
		$data['isi'] = $this->load->view('kondsos/parPol/index', $this->data, true);
	...
	public function show($id)
	{
		...
		$this->data['parpol'] = $this->parpol->find(decrypt($id));
	...
	public function store(){
		...
		$this->form_validation->set_rules('dominasi', 'Dominasi', 'trim|required');
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$data = array(
				...
				'dominasi_wilayah'	=> $this->input->post('dominasi'),
	...
	public function delete($id=null)
    {
		...
		if ($this->parpol->delete(decrypt($id))) {
