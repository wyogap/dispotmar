...
class Komcad extends CI_Model
{
    ...
    public function get($filter = null)
    {
        ...
        $this->db->join("org_geografi w3", "w3.id_geografi=a.id_kabupaten and w3.is_active=1", "LEFT OUTER");
        $this->db->join("org_geografi w4", "w4.id_geografi=a.id_provinsi and w4.is_active=1", "LEFT OUTER");
    ...
    public function getRankCriminals()
	{
        ...
        $this->db->where("activity.id_activity_jenis", static::$ACTIVITYID_KOMCAD);
    ...
    public function getReportCount($satker = null, $startDate = null, $finishDate = null)
    {
        ...
        $this->db->where("A.id_activity_jenis", static::$ACTIVITYID_KOMCAD);
