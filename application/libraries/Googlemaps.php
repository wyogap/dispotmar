...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyDbSJFRaDpoju3BW9Rgm4t0Kjg8rtnciRw'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= '-6.1755367,106.8273503';		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	var $onplace					= '';						// The JavaScript action to perform when themap center property changes
	...
	function add_marker($params = array())
	{
		...
		$marker['onplace'] = ''; 								// blank, 'DROP' or 'BOUNCE'
	...
	function create_map()
	{
		...
		$this->output_js_contents .= '
		var marker;
		function placeMarker_'.$this->map_name.'(markerOptions) {
			if(marker){
